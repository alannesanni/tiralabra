...
class Kayttoliittyma:
    ...
    def seuraava_nappula(self):
        ...
        if self.tiedot.pelaaja==1:
            pygame.draw.circle(self.naytto,PUNAINEN,(nappulan_x_koordinaatti,50),49)
        if self.tiedot.pelaaja==2:
            pygame.draw.circle(self.naytto,KELTAINEN,(nappulan_x_koordinaatti,50),49)
    ...
    def voitto(self):
        ...
        voitto=fontti.render(f"PELAAJA {self.tiedot.pelaaja} VOITTI!",0,MUSTA)
